import { Renderer, Program, Mesh, Color, Triangle } from './vendor/ogl-1.0.11.mjs';

// ReactBits Galaxy:
// https://reactbits.dev/backgrounds/galaxy
// The official shader and rendering logic are preserved below. Only the React
// lifecycle wrapper is replaced so the component can mount in this static site.
...
export function createReactBitsGalaxy(ctn, options = {}) {
  if (!ctn) throw new Error('ReactBits Galaxy requires a container element.');
  ...
  gl.canvas.dataset.reactbitsGalaxy = '';
  ctn.dataset.galaxyRenderer = 'reactbits';
